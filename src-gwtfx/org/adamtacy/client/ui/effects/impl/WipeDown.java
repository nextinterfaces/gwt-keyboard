 ...
 * 
 */
public class WipeDown extends ClipBase {

  public WipeDown() {
    super();
  }

  public WipeDown(String startClip, String endClip) {
    super(startClip, endClip);
  }
  
  public WipeDown(Element el){
    this();
    //effectElement = el;
    addEffectElement(el);
  }
  
  public WipeDown(Element el, String startClip, String endClip) {
